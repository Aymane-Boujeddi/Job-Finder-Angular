...
export const removeFavorite = createAction('[Favorites] Remove Favorites',props<{id : number}>());

export const removeFavoriteSuccess = createAction('[Favorites] Remove Favorites Success', props<{id : number}>());

export const removeFavoriteFailure = createAction('[Favorites] Remove Favorites Failure', props<{error : string}>());